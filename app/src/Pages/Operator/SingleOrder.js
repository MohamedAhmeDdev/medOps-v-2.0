          ...
          <div className="relative flex flex-col h-full min-w-0 mb-6 break-words bg-white border-0 shadow-soft-xl rounded-lg bg-clip-border">    
              <div className="flex-auto p-4 pt-6">
                ...
                <ul className="flex flex-col px-10 mb-0 rounded-lg">
                  <li className="relative flex justify-between px-4 py-2 pl-0 mb-2 border-0 rounded-t-inherit text-inherit">
                    <div className="flex items-center">
                      <div className="flex flex-col">
                  ...
                  <li className="relative flex justify-between px-4 py-2 pl-0 mb-2 border-0 border-t-0 text-inherit">
                    <div className="flex items-center">
                      <div className="flex flex-col">
                  ...
                  <li className="relative flex justify-between px-4 py-2 pl-0 mb-2 border-0 border-t-0 text-inherit">
                    ...
                    <div className="flex flex-col items-center justify-center">
                    <span className="bg-green-100 text-green-500 rounded-md text-sm mr-2 px-2.5 border border-green-50">Cancelled</span>
                    </div>
                  </li>
                  <li className="relative flex justify-between px-4 py-2 pl-0 mb-2 border-0 border-t-0 text-inherit">
                    <div className="flex items-center">
