      ...
      <div className="flex flex-1 relative">
        ...
        <div className="flex flex-col flex-1 bg-gray-50 overflow-x-hidden overflow-y-auto">
          ...
          <main className="max-h-screen flex flex-col  h-[100vh]"> 
            ...
            <h6 className="pb-5 font-bold text-4xl px-1.5 lg:px-6 capitalize">Deliveries</h6>
                            ...
                            <tbody className="bg-white ">
                              <tr className="bg-gray-50">
                                ...
                                <td className="p-4 whitespace-nowrap text-center">
                                  <span className="bg-green-300 text-green-800 text-md mr-2 px-2.5 py-0.5 border border-green-400">DELIVERED</span>
                                </td>
                              ...
                              < td className="p-4 text-md text-center text-gray-400 whitespace-nowrap">4545454</td>
                                ...
                                <td className="p-4 text-md text-center text-gray-400 whitespace-nowrap">$2300</td>
                                <td className="p-4 whitespace-nowrap text-center">
                                  <span className="bg-red-300 text-red-800 text-md mr-2 px-2.5 py-0.5 border border-red-400">Cancelled</span>
                                </td>
                                <td className="p-4 text-md text-gray-400 whitespace-nowrap">
                                    <Link to='/SingleOrderDelivery' className="text-md leading-tight font-semibold text-slate-400 hover:text-blue-500"> View </Link>
                                </td>
                              ...
                              <td className="p-4 text-md text-center text-gray-400 whitespace-nowrap">4545454</td>
                                ...
                                <td className="p-4 text-md text-center text-gray-400 whitespace-nowrap">$2300</td>
                                <td className="p-4 whitespace-nowrap text-center">
                                  <span className="bg-purple-300 text-purple-800 text-md mr-2 px-2.5 py-0.5 border border-purple-400">PENDING</span>
                                </td>
                                <td className="p-4 text-md text-gray-400 whitespace-nowrap">
                                    <Link to='/SingleOrderDelivery' className="text-md leading-tight font-semibold text-slate-400 hover:text-blue-500"> View </Link>
                                </td>
                              ...
                              <tr>
                                ...
                                <td className="p-4 whitespace-nowrap text-center">
                                  <span className="bg-orange-300 text-orange-800 text-md mr-2 px-2.5 py-0.5 border border-orange-400">PACKED</span>
                                </td>
