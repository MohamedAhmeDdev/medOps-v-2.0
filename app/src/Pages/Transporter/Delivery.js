            ...
            <h6 class="pb-5 font-bold text-4xl capitalize">Deliveries</h6>
               ...
               <div class="flex flex-wrap py-5">
                  <div class="flex-none w-full max-w-full">
                    <div class=" flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">     
                      <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-0 overflow-x-auto">
                          <table class="min-w-full divide-y divide-gray-200 ">
                          <thead class="align-bottom">
                              <tr>
                                <th class="p-4 text-lg font-medium tracking-wider text-left text-black uppercase">Order Id</th>
                                <th class="p-4 text-lg font-medium tracking-wider text-left text-black uppercase">Phone Number</th>
                                <th class="p-4 text-lg font-medium tracking-wider text-left text-black uppercase">Total Amount</th>
                                <th class="p-4 text-lg font-medium tracking-wider text-left text-black uppercase">Status</th>
                                <th class="p-4 text-lg font-medium tracking-wider text-left text-black uppercase">Action</th>
                                <th class="p-4 text-lg font-medium tracking-wider text-left text-black uppercase">View</th>
                              </tr>
                          </thead>
                            <tbody class="bg-white ">
                              <tr class="bg-gray-50 ">
                                ...
                                <td class="p-4 text-md font-semibold whitespace-nowrap dark:text-gray-400">
                                   <button class="inline-block px-4 py-1 mb-0 font-bold text-center uppercase bg-green-300 border border-solid rounded-lg cursor-pointer text-4 bg-150 text-black  hover:border-green-300">Confirm Order</button>
                              </td>
