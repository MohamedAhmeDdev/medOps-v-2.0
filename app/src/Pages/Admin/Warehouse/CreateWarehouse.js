     ...
     <div className="flex flex-1 relative">
       ...
       <div className="flex flex-col flex-1 bg-gray-50 overflow-x-hidden overflow-y-auto">
         ...
         <main className="max-h-screen flex flex-col  h-[100vh]">          
           ...
           <h6 className="pb-5 font-bold px-1.5 lg:px-6 text-lg capitalize">create Warehouse</h6>
                                ...
                                <div className="flex-auto p-6">
                                  ...
                                  <div className="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                      <div className="mb-4 py-3">
                                        <label htmlFor="email" className="inline-block mb-2 ml-1 font-bold text-md text-slate-700 capitalize">Warehouse_Name</label>
                                    ...
                                    <div className="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                      <div className="mb-4 py-3">
                                        <label htmlFor="email" className="inline-block mb-2 ml-1 font-bold text-md text-slate-700 capitalize">Warehouse_Address</label>
                                        <input type="text" className="focus:shadow-lg focus:shadow-blue-100 text-sm ease block w-full rounded-md border border-solid border-gray-300 bg-white px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"/>
                                      </div>
                                    </div>
                                    <div className="w-full max-w-full mx-auto px-3 shrink-0 md:w-6/12 md:flex-0">
                                      <div className="mb-4 py-3">
                                        <label htmlFor="first name" className="inline-block mb-2 ml-1 font-bold text-md text-slate-700 capitalize">Manager</label>
                                        <input type="text" className="focus:shadow-lg focus:shadow-blue-100 text-sm ease block w-full rounded-md border border-solid border-gray-300 bg-white px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none"/>
                                      </div>
                                    </div>       
                                  </div>
