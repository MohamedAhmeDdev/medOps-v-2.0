                  ...
                  <div className="flex-none w-full max-w-full">
                    <div className=" flex flex-col mb-10 break-word border-0 border-transparent border-solid bg-clip-border">     
                      <div className="flex-auto px-0 pt-0 pb-2">
                        ...
                        <table className="items-center w-full mb-0 align-top border-gray-200 text-slate-500  overflow-x-hidden  overflow-y-hidden ">
                        <thead className="align-bottom bg-slate-500">
                            ...
                            <tbody className="mb-0 text-sm leading-tight p-2 py-3 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                              {medicines.length === 0 && (
