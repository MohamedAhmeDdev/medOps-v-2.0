...
function Medicine() {
  ...
  useEffect(() => {
		const getMedicine = async () => {
		  const data = await axios.get(`${LOGISTICS_SERVER_URL}/medicine`);
                        ...
                        <table className="items-center w-full mb-0 align-top border-gray-200 text-slate-500 ">
                          <thead className="align-bottom bg-slate-500">
                              <tr>
                                ...
                                <th className="px-6 py-2 font-semibold text-center text-sm uppercase align-middle bg-transparent border-b border-gray-200 shadow-none border-b-solid tracking-none whitespace-nowrap text-white opacity-70">medicine_Image</th>
                              ...
                              <tr key={id} className="bg-gray-50">
                                ...
                                <td className="mb-0 text-sm leading-tight p-2 py-3 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                 <div className="w-20 h-20">
                                   <img className="ml-20 " src={medicine.medicine_image} alt={medicine.medicine_name} />
                                 </div>
                                  </td>
                                ...
                                <td className="mb-0 text-sm leading-tight p-2 py-3 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent cursor-pointer">
                                   < Link to={`/logistics/update-medicine/${medicine.medicine_id}`} className="text-md font-semibold leading-tight text-slate-400 hover:text-blue-500">Edit </Link>
                                </td>
                              </tr>  
                              ))}
                            </tbody>
