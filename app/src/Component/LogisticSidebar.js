...
function LogisticSidebar({ sidebarOpen, toggleSidebar }) {
  ...
  return (
    ...
    <hr className="h-px mt-0 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent" />
      ...
      <ul className="flex flex-col pl-0 mb-3 pt-5 space-y-2.5">
        <li className="mt-0.5 w-full">
          <Link to='/logistics' className="py-2.5 px-10 hover:shadow-lg hover:bg-white text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg font-semibold text-slate-700 transition-colors">
        ...
        <li className="mt-0.5 w-full">
          <Link to='/order' className="py-2.5  px-10 text-sm hover:shadow-lg hover:bg-white ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg  font-semibold text-slate-700 transition-colors">
            <div className="shadow-lg mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center  p-5">
        ...
        <li>
          <Link onClick={() =>setOpenCategory(!openCategory)} className="py-2.5  px-10 text-sm hover:shadow-lg hover:bg-white ease-nav-brand my-0 mx-2.5 flex items-center whitespace-nowrap rounded-lg font-semibold text-slate-700 transition-colors">
            <div className="shadow-lg mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center  p-5">
               <span className="material-symbols-outlined">category</span>
              </div>
              <span className="text-4.5 duration-300 opacity-100 pointer-events-none ease-soft">Medicine Category</span>
          </Link>
          {openCategory && (
              ...
              <ul className="text-sm">
                 <li className="mt-0.5 w-full">
                  <Link to='/medicineCategory' className="py-2.5  px-10 text-sm hover:shadow-lg hover:bg-white ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg font-semibold text-slate-700 transition-colors">
                    ...
                    <span className="text-4.5 duration-300 opacity-100 pointer-events-none ease-soft">Category</span>
                  </Link>
               </li>
                <li className="mt-0.5 w-full">
                  <Link to='/createCategory' className="py-2.5  px-10 text-sm hover:shadow-lg hover:bg-white ease-nav-brand my-0 mx-3 flex items-center whitespace-nowrap rounded-lg font-semibold text-slate-700 transition-colors">
                    {/* <div className="shadow-lg mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center p-5">
                      <span class="material-symbols-outlined">add_circle</span>
                    </div> */}
                    <span className="text-4.5 duration-300 opacity-100 pointer-events-none ease-soft">Create Category</span>
                  </Link>
                </li>
              </ul>
            </div>
        ...
        <li>
          <Link onClick={() =>setOpenMedicine(!openMedicine)} className="py-2.5  px-10 text-sm hover:shadow-lg hover:bg-white ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg font-semibold text-slate-700 transition-colors">
            <div className="shadow-lg mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center  p-5">
          ...
          {openMedicine && (
            <div className="pl-1 ml-1 transition border-gray-500 dropdown-section nested-menu">
              <ul className="text-sm">
                ...
                <li className="mt-0.5 w-full">
                  <Link to='/createMedicine' className="py-2.5  px-10 text-sm hover:shadow-lg hover:bg-white ease-nav-brand my-0 mx-3 flex items-center whitespace-nowrap rounded-lg font-semibold text-slate-700 transition-colors">
                    {/* <div className="shadow-lg mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center p-5">
                      <span class="material-symbols-outlined">add_circle</span>
                    </div> */}
                    <span className="text-4.5 duration-300 opacity-100 pointer-events-none ease-soft">Create Medicine</span>
                  </Link>
                </li>
              </ul>
            </div>
